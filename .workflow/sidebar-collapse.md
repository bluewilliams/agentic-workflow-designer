...
- The 13 ids (since 2026-08-07): requirements, workflow-context, default-model, repositories, add-nodes, presets, app-under-test, ui-context, workflow-management, mcp-integrations, memory-durable-record, run-reports, node-config.
