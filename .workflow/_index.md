...
- status: current | date: 2026-07-01 | note: 1189 -> 1190. No test pinned the old "Additional context" string (grep-confirmed pre-edit) so nothing broke; the new test asserts "Agent Context" present + "additional context" absent everywhere. Content-lint. One unrelated "additional context" line (decision re-spawn feedback) correctly left alone.
