...
- status: current | date: 2026-09-11 | note: 1643 -> 1722 across the build, live shakedowns, and ten review rounds (regression pins include handler injection, re-grant timer, lapsed-watch wipe, duplicate-label slugs, revise-status ordering, false half-ticks, capped phantom-new, frozen-board same-size ticks). Visual proof over the fullstack preset plus a real multi-hour run.
