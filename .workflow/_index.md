...
- status: current | date: 2026-09-23 | note: idle fold (evaluated every poll cycle; IDLE badge, dated card, Show anyway) + inline task markup via inlineFmt; suite 1755.
