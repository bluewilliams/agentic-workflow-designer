...
├── tests.html       # iframe-based test suite (~1,210 lines, 190 tests)
...
**Coverage** (190 tests across 14 suites):
...
- **Run tests after changes**: Run `./run-tests.sh` from CLI or open `tests.html` in a browser. All 190 tests should pass
